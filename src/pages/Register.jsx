...
import { User, Lock, Loader2, Mail, Eye, EyeOff, UserPlus } from "lucide-react";
...
const Register = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-600 via-blue-600 to-purple-600 p-4">
          ...
          <div className="relative">
            <div className="flex items-center bg-white/20 rounded-lg px-3 py-2 border border-white/30">
              ...
              <input
                ...
                required
                className="w-full p-2 bg-transparent text-white placeholder-gray-200 focus:outline-none"
                disabled={loading}
              />
            </div>
          </div>
  ...
  {loading ? (
    ...
    "Create Account"
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-red-500 text-white py-3 rounded-lg hover:bg-red-600 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
